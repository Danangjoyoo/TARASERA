...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.spinBox_fistN.setGeometry(QtCore.QRect(130, 80, 71, 22))
        self.spinBox_fistN.setMinimum(1)
        self.spinBox_fistN.setMaximum(20)
        self.spinBox_fistN.setProperty("value", 17)
        self.spinBox_fistN.setObjectName("spinBox_fistN")
        self.spinBox_palmN = QtWidgets.QSpinBox(self.hcc_tab)
        self.spinBox_palmN.setGeometry(QtCore.QRect(130, 160, 71, 22))
        self.spinBox_palmN.setMinimum(1)
        self.spinBox_palmN.setMaximum(20)
        self.spinBox_palmN.setProperty("value", 13)
        self.spinBox_palmN.setObjectName("spinBox_palmN")
        self.label_blurSize = QtWidgets.QLabel(self.hcc_tab)
        self.label_blurSize.setGeometry(QtCore.QRect(230, 40, 131, 20))
        ...
        self.label_frameInputSize.setGeometry(QtCore.QRect(230, 80, 131, 20))
        self.label_frameInputSize.setObjectName("label_frameInputSize")
        self.label_movingAvgSize = QtWidgets.QLabel(self.hcc_tab)
        self.label_movingAvgSize.setGeometry(QtCore.QRect(230, 120, 131, 20))
        ...
        self.spinBox_fistSF.setGeometry(QtCore.QRect(130, 40, 71, 22))
        self.spinBox_fistSF.setDecimals(2)
        self.spinBox_fistSF.setMinimum(0.01)
        self.spinBox_fistSF.setMaximum(0.99)
        self.spinBox_fistSF.setSingleStep(0.01)
        self.spinBox_fistSF.setProperty("value", 0.8)
        self.spinBox_fistSF.setObjectName("spinBox_fistSF")
        self.spinBox_palmSF = QtWidgets.QDoubleSpinBox(self.hcc_tab)
        self.spinBox_palmSF.setGeometry(QtCore.QRect(130, 120, 71, 22))
        self.spinBox_palmSF.setMinimum(0.01)
        self.spinBox_palmSF.setMaximum(0.99)
        self.spinBox_palmSF.setSingleStep(0.01)
        self.spinBox_palmSF.setProperty("value", 0.93)
        self.spinBox_palmSF.setObjectName("spinBox_palmSF")
        self.spinBox_frameInputSize = QtWidgets.QDoubleSpinBox(self.hcc_tab)
        self.spinBox_frameInputSize.setGeometry(QtCore.QRect(380, 80, 76, 22))
        ...
        self.pushButton_Instruction.setGeometry(QtCore.QRect(200, 160, 241, 36))
        ...
        self.checkBox_test = QtWidgets.QCheckBox(self.groupBox)
        self.checkBox_test.setGeometry(QtCore.QRect(10, 100, 111, 20))
        ...
        self.checkBox_showWin.setGeometry(QtCore.QRect(10, 130, 111, 20))
        ...
        self.checkBox_showDetBorder.setGeometry(QtCore.QRect(10, 160, 131, 20))
    ...
    def getVal(self):
        ...
        root.withdraw()
        mbox.showinfo(title='Save Status',message='Parameters Have Been Saved Successfully!')
        root.destroy()
        fistSF = round(2.0-self.spinBox_fistSF.value(),2)
        fistN = 20-self.spinBox_fistN.value()
        palmSF = round(2.0-self.spinBox_palmSF.value(), 2)
        palmN = 20-self.spinBox_palmN.value()
        ...
        test = self.checkBox_test.checkState()
        showWin = self.checkBox_showWin.checkState()
        showBorder = self.checkBox_showDetBorder.checkState()

        self.packedSetupVal = [[fistSF, fistN, palmSF, palmN, blurSize,inputSize,avgSize],[cam_id,test,showWin, showBorder]]
        global parameters
        parameters = self.packedSetupVal
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.label_fistSF.setText(_translate("mainWindow", "Fist Accuracy"))
        self.label_fistN.setText(_translate("mainWindow", "Fist Sensitivity"))
        self.label_palmSF.setText(_translate("mainWindow", "Palm Accuracy"))
        self.label_palmN.setText(_translate("mainWindow", "Palm Sensitivity"))
        self.label_blurSize.setText(_translate("mainWindow", "Processed Kernel Size"))
        self.label_frameInputSize.setText(_translate("mainWindow", "Processed Frame Ratio"))
        self.label_movingAvgSize.setText(_translate("mainWindow", "Cursor Stability"))
        ...
        self.label_3.setText(_translate("mainWindow", "These parameters have been set to suit general devices specification. On some device might work, but on the other cases you have to change it to get the best performance!"))
        self.pushButton_Instruction.setText(_translate("mainWindow", "CLICK HERE FOR FULL INSTRUCTIONS!"))
        self.label_cameraID.setText(_translate("mainWindow", "Camera ID"))
        self.groupBox.setTitle(_translate("mainWindow", "Vision Setting"))
        self.checkBox_test.setText(_translate("mainWindow", "Cursor Control"))
